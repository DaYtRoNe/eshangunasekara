                ...
                >
                  ...
                  <div className="flex justify-between items-start mb-6 relative z-10">
                    ...
                    <div className="flex gap-3">
                      <a href={project.github} className="p-2 bg-white/5 border border-white/10 rounded-lg text-gray-400 hover:text-white hover:border-primary/50 transition-colors cursor-hover hover:shadow-[0_0_10px_rgba(170,59,255,0.2)]">
                        <FaGithub className="w-5 h-5" />
                      </a>
                      <a href={project.demo} className="p-2 bg-white/5 border border-white/10 rounded-lg text-gray-400 hover:text-white hover:border-primary/50 transition-colors cursor-hover hover:shadow-[0_0_10px_rgba(170,59,255,0.2)]">
